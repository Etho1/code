...
def main():
    ...
    draw_pine_tree(canvas, 600, 70, 220)
    draw_pine_tree(canvas, 300, 130, 120)
    draw_pine_tree(canvas, 450, 70, 400)
    draw_rock(canvas, scene_width, scene_height, 10, 25)
...
def draw_sky(canvas, scene_width, scene_height):
    draw_rectangle(canvas, 0, 165, scene_width, scene_height, outline='royalblue1', fill='royalblue1')
