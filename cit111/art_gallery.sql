...
insert into art_gallery.artist (artist_id, fname, mname, lname, dob, dod, country, local_artist)
values 
	(1,'Vincent',NULL,'van Gogh', 1853, 1890, 'France', 'n'),
	(2,'Rembrendt','Harmenszoon','van Rijn',1606,1669,'Netherlands','n'),
...
INSERT INTO art_gallery.artwork (artwork_id, title, artyear, period, arttype, artfile, artist_id)
values
    ...
    (4,'Night Watch',1642,'Baroque','Oil','headwoman.jpg',2),
    ...
    (10,'Old Barn',1992,'Modern','Oil','hillsidestream.jpg',4),
...
INSERT INTO art_gallery.keyword (keyword_id, keyword)
values
	(1,'flowers'),
    (2,'blue'),
    (3,'landscape'),
