...
CREATE TABLE `order` (
  ...
  `cusotmer_id` int NOT NULL,
  PRIMARY KEY (`order_id`),
  KEY `fk_order_cusotmer_idx` (`cusotmer_id`),
  CONSTRAINT `fk_order_cusotmer` FOREIGN KEY (`cusotmer_id`) REFERENCES `customer` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-01-14 17:01:28
